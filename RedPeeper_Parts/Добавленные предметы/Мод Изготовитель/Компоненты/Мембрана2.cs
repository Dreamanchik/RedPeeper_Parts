...
public class Мембрана2
{
    ...
    public static void Register()
    {
        Info = PrefabInfo.WithTechType(
            ...
            "Мембрана",
            "Тонкая органическая пластина, синтезированная из биологических образцов жизнедеятельности рифоспинов. Подходит для создания герметичных упаковок и высокотехнологичных линз."
            )
