...
public class ПространственныйПроцессор
{
    ...
    public static string mainTexturePath = Path.Combine(modFolder, "Assets", "Doodads", "ModifiedFabricator", "Components", "SpatialProcessor", "SpatialProcessor_texture.png"); //  <-- Путь к текстуре
