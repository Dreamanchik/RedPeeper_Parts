...
public class DegasiBasePieceCorridorTopOpen
{
    public static PrefabInfo Info { get; set; } = PrefabInfo.WithTechType("DegasiBasePieceCorridorTopOpen", "База дегази", "У тебя не должно быть доступа к этому...");
