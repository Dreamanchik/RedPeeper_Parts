...
public class ВоздушнаяПодушка
{
    ...
    public static void Register()
    {
        Info = PrefabInfo.WithTechType(
            ...
            "RedPeeper_Airbag",
            "Воздушная подушка",
            "Лёгкая и воздушная ткань, способная сжиматься и разжиматься, способствуя перемещению транспорта в толще воды. Используется в производстве конструкционных обшивок и крупных воздушных ёмкостей."
            )
