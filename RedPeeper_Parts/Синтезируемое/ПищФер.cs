...
public class ПищФер
{
    ...
    public static void Register()
    {
        Info = PrefabInfo.WithTechType(
            ...
            "Клетки желудка морского топтуна, позволяющие ему переваривать даже грубую глубоководную пищу. Подходит для создания специализированного и сложного биотоплива."
            )
