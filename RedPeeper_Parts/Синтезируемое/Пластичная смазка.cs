...
public class RedPeeper_EffectiveLubrication
{
    ...
    public static void Register()
    {
        ...
        var _obj = new CloneTemplate(Info, TechType.Lubricant); // КОПИРУЕМ ПРЕФАБ НА ОСНОВЕ ТЕЧТАЙПА
