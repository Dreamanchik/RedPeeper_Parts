...
public static class DNASampler
{
    ...
    public static void Register()
    {
        Info = PrefabInfo.WithTechType(
            "DNASampler",
            "ДНК-передатчик",
            "Портативное устройство, позволяющее собирать уникальные образцы ДНК из внутренних оболочек инопланетной фауны. Использует упаковочную ткань в качестве упаковочного материала."
            )
